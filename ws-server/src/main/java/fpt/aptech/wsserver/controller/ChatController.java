package fpt.aptech.wsserver.controller;

import fpt.aptech.wsserver.model.Message;
...
public class ChatController {
    ...
    public fpt.aptech.wsserver.model.Message receiveMessage(@Payload Message message){
        return message;
    }
